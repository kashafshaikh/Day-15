...
function areAnagrams(str1, str2) {
    var normalize = function (str) { return str.toLowerCase(); };
    str1 = normalize(str1);
    str2 = normalize(str2);
    ...
    var charCount1 = getCharCount(str1);
    var charCount2 = getCharCount(str2);
...
function reverseWords(sentence) {
    ...
    for (var i = 0; i < sentence.length; i++) {
        ...
        if ((sentence[i] === ' ' || i === sentence.length - 1) && wordStart !== -1) {
            var wordEnd = (sentence[i] === ' ') ? i : i + 1;
            words.push(sentence.substring(wordStart, wordEnd));
            wordStart = -1;
        }
    }
    var reversedWords = '';
